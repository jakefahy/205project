...
import glob
from lsb_steganography import encoding
#Jacob Fahy worked on this file

#getting the image from google
def keyword(string):
    ...
    for item in new_list:
        if item != new_list[-1]:
            ...
            arguments = {"keywords":other_string,"limit":1,"print_urls":True,"format":"png"}
